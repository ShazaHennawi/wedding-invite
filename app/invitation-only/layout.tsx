...
const pageUrl = new URL(isGitHubPages ? "invitation-only.html" : "invitation-only", siteUrl).toString();
...
export default function InvitationOnlyLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return children;
}
