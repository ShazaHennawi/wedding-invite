...
const pageUrl = new URL(isGitHubPages ? "ceremony-invitation.html" : "ceremony-invitation", siteUrl).toString();
const imageUrl = new URL("og-invitation-20260825.png", siteUrl).toString();
const title = "Ceremony Invitation — Isaac & Shaza";
...
export default function CeremonyInvitationLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return children;
}
