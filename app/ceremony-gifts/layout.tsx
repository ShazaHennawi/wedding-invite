...
const pageUrl = new URL(isGitHubPages ? "ceremony-gifts.html" : "ceremony-gifts", siteUrl).toString();
...
export default function CeremonyGiftsLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return children;
}
